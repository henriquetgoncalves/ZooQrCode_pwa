var QRReader = document.createElement("script");
QRReader.type = "text/javascript";
QRReader.src = './vendor/qrscan.js';


var snackbar = document.createElement("script");
snackbar.type = "text/javascript";
snackbar.src = './snackbar.js';

var styles = document.createElement("stylesheet");
styles.type = "text/css"
styles.src = '../css/qrcode.css';

var isURL = document.createElement("script");
isURL.type = "text/javascript";
isURL.src = 'is-url';
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    if (!window.iOS) {
        ...
        scanBtnElement.addEventListener('click', () => {
            show('Scanning please wait...', 2000);
